...
<div id="menuAddDiv" style="display: none;">
    <form class="form-horizontal" >
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control"  id="add_menuName" placeholder="请输入分类名...">
            </div>
        </div>
    </form>
</div>
...
<div id="menuUpdateDiv" style="display: none;">
    <form class="form-horizontal" >
        <div class="form-group">
            <label  class="col-sm-2 control-label">分类名</label>
            <div class="col-sm-4">
                <input type="text" class="form-control"  id="update_menuName" placeholder="请输入分类名...">
            </div>
        </div>
    </form>
</div>
                    ...
                    confirm: {
                        ...
                        callback: function(){
                            ...
                            $.ajax({
                                ...
                                data:{"fatherId":v_fatherId,"categoryName":v_menuName},
                                success:function (result) {
                                    if (result.code == 200) {
                                        // 刷新
                                        var resourceNode = {id:result.data,categoryName:v_menuName,fatherId:v_fatherId};
                                        // 调用ztree的方法动态在前台添加节点
